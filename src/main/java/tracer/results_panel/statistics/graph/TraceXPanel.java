...
//
//public class TraceXPanel extends JPanel {
//
...
//
//
//    public TraceXPanel(ArrayList<Trace>[] traceArr)
//    {
...
//
//        org.jfree.chart.axis.NumberAxis rangeAxis = new org.jfree.chart.axis.NumberAxis("X Position vs. Time");
...
//
//            double[] x_array = new double[pointList.size()];
//
//            for (int i = 0; i < pointList.size(); ++i) {
//                x_array[i] = (double) pointList.get(i).x;
//            }
//
//            double[] nx_array = StatUtils.normalize(x_array);
//
//            for (int i = 0; i < testTrace.points.size(); ++i) {
//
//                series.add(i, nx_array[i]);
//            }
//
