...
public class TraceVelocityPanel extends JPanel {
    ...
    public TraceVelocityPanel(ArrayList<Trace>[] traceArr)
    {
        ...
        org.jfree.chart.axis.NumberAxis rangeAxis = new org.jfree.chart.axis.NumberAxis("Velocity");
